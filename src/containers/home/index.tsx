export default function HomePage() {
  return (
    <div className="container text-center my-5">
      ...
      <h5>
        FitHobo.com also offers a book session where the customers can
        physically attend. Anyone can buy & sell diet, fitness & wellness
        products and services through this platform. For service providers
        authenticity is being verified so that customers always get the best
        service from FitHobo.com. Customers can compare between products and
        services to choose the best possible option for them. And all the
        products and service providers are closely monitored before going into
        the platform. “One Life, Live Healthy” is the simple yet strong motto of
        FitHobo.com
      </h5>
    </div>
  );
